...
export default function Login() {
    return (
        ...
        <div className="h-full md:mx-10 ">
          ...
          <div className="g-6 flex h-full  items-center justify-center lg:justify-between flex flex-col lg:flex-row">
            <div className="shrink-1 mb-6 mt-8 grow-0 basis-auto md:mb-0 md:w-9/12 md:shrink-0 lg:w-6/12 xl:w-6/12 ">
              <img
                src="/Login.svg"
                className="w-full h-[30em] mt-4 mb-4"
                alt="Sample image"
              />
            </div>
            ...
            <div className="mb-12 md:mb-0  w-3/4 lg:w-1/2 ">
              <form>
                ...
                <div className="flex flex-col md:flex-row items-center justify-center ">
                  <p className="md:mb-0 mr-4 text-lg mb-4">Sign in with</p>
                <div>
                  {/* <!-- Facebook button--> */}
